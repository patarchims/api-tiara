...
func (s *Service) RoutingFiberAndListener(Logging *logrus.Logger) {
	...
	api.Post("batal-antrean-all", rest.JWTVeifyHandler(Logging), s.AntrianHandler.BatalAllAntreanFiberHandler)
	...
	api.Post("batal-all-antrean", s.AntrianHandler.AmbilAntreanFiberHandler)
